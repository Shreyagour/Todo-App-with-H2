...
//	InMemoryUserDetailsManager InMemoryUserDetailsManager(UserDetails...users);
	...
	public InMemoryUserDetailsManager createUserDetailsManager() {
		...
		UserDetails userDetails = createNewUser("Shreya Gour", "dummy");
		UserDetails userDetails2 = createNewUser("Jaya Gour", "dummyj");
		UserDetails userDetails3 = createNewUser("Chinka Bharadwaj", "dummyc");
